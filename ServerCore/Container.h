...
template<typename Key, typename Type, typename Hash = std::hash<Key>, typename KeyEqual = std::equal_to<Key>>
using UnorderedMap = unordered_map<Key, Type, Hash, KeyEqual, StlAllocator<pair<const Key, Type>>>;
